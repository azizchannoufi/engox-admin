...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "flex h-full flex-col border-r border-[#e7ebf0] bg-white transition-[width] duration-200",
    ...
    >
      ...
      <div className="border-t border-[#e7ebf0] p-3">
        ...
        <button
          onClick={toggle}
          className="flex h-8 w-full items-center justify-center rounded-md text-gray-1 hover:bg-navy-50 hover:text-navy"
